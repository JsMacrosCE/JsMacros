...
import xyz.wagyourtail.client.api.event.impl.*;
import xyz.wagyourtail.client.api.event.impl.inventory.*;
import xyz.wagyourtail.client.api.event.impl.player.*;
import xyz.wagyourtail.client.api.event.impl.world.*;
import xyz.wagyourtail.client.api.helper.*;
import xyz.wagyourtail.client.api.library.impl.*;
